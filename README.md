...
└── InfoHub-Backend.postman_collection.json # API testing collection
...
### Server (`server/.env`)
PORT=5000
WEATHER_API_KEY=66f70c3969a272ed5f7963f46cb5ebdf
...
```bash
git clone https://github.com/Rakesh-Gurrala/InfoHub-Challenge.git
